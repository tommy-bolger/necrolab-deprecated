function process_deathless_data(data, players_table) {
    var processed_data = [];
...
$(document).ready(function() {
    ...
    players_table.setAjaxUrl('/api/rankings/power/deathless/entries');
    ...
    players_table.setDefaultSort('deathless_rank', 'asc');
    
    players_table.setDataProcessCallback(window, 'process_deathless_data');
