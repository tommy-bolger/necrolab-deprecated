function process_score_data(data, players_table) {
    var processed_data = [];
...
$(document).ready(function() {
    ...
    players_table.setAjaxUrl('/api/rankings/power/score/entries');
    ...
    players_table.setDefaultSort('score_rank', 'asc');
    
    players_table.setDataProcessCallback(window, 'process_score_data');
