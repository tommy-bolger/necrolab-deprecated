...
extends Rankings {
    ...
    public static function getLatestRankingsFromCache($page_number = 1, $rows_per_page = 100) {
        ...
        $resultset = new Redis(CacheEntryNames::POWER_RANKING_SPEED, $cache);
        
        $resultset->setEntriesName(CacheEntryNames::POWER_RANKING_SPEED_ENTRIES);
        $resultset->setFilterName(CacheEntryNames::POWER_RANKING_SPEED_ENTRIES_FILTER);     
        ...
        $resultset->addProcessorFunction(function($result_data) {
            return static::processResultsetDisplay('speed', $result_data);
        });
